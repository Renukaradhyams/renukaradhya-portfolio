...
const skillCategories = [
  {
    ...
    skills: ["HTML5", "CSS3", "JavaScript (ES6+)", "Bootstrap", "Tailwind CSS", "React.js"],
  ...
  },
  {
    ...
    skills: ["Microsoft Azure", "Netlify", "Vercel"],
  ...
  },
  {
    ...
    skills: ["Visual Studio Code", "Figma", "Postman", "Chrome DevTools"],
